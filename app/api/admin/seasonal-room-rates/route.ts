...
function logEnvPresenceDev(): void {
  ...
  console.log('[api/admin/seasonal-room-rates] ADMIN_API_SECRET (boolean):', Boolean(adminApiSecret()));
  console.log('[api/admin/seasonal-room-rates] NEXT_PUBLIC_SAAS_API_BASE_URL (boolean):', Boolean(saasBaseUrl()));
}
...
async function forwardToSaaS(method: 'GET' | 'PUT', body?: unknown): Promise<Response> {
  ...
  const url = `${base}/api/admin/seasonal-room-rates`;
