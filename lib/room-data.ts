...
export const ROOMS: Record<RoomSlug, RoomDetail> = {
  ...
  pg3: {
    ...
    images: [
      '/hotel3/pg3-three-01.webp',
      '/hotel3/pg3-three-02.webp',
      '/hotel3/pg3-three-03.webp',
      '/hotel3/pg3-three-04.webp',
      '/hotel3/pg3-three-05.webp',
    ],
  },
  'pg3-four': {
    slug: 'pg3-four',
    checkoutRoom: 'pg3_four',
    name: 'HOTEL PG-III 4名タイプ',
    subtitle: '【OPEN記念価格】2名利用でお得｜和モダン客室｜最大4名｜無料駐車場｜長期滞在歓迎',
    address: '広島県尾道市因島土生町1747-5',
    mapLabel: 'HOTEL PGⅢ',
    facts: [
      { label: '個室', value: '個室' },
    ...
    plan: {
      title: '詳細',
      description: [
        '和モダンデザインの落ち着いた客室で、最大4名様までご利用いただけます。全室バス・トイレ付きで、観光・出張どちらにも快適にお過ごしいただけます。',
        '無料駐車場を完備しており、普通車はもちろんマイクロバスも駐車可能です。団体様や工事関係・企業様の長期滞在にも最適です。',
        '館内には共用の洗濯機・ガス乾燥機を完備しており、連泊や長期宿泊にも便利です。尾道観光の拠点としてもご利用ください。',
      ],
    },
    ...
    about: [
      ...
      '洗濯機、ガス乾燥機、調理器具もあり、長期滞在も可能！',
      '無料駐車場完備で普通車はもちろん、マイクロバスの駐車も可能です。',
      '3名までのプラン（3名タイプ）と、最大4名までのプラン（4名タイプ）をご用意しています。',
      '出張・観光・サイクリストの拠点としても便利です。',
      'セルフチェックイン対応のため、到着時間を気にせずご利用いただけます。',
    ],
    bedTypes: ['布団/床用マットレス 2', 'ソファベッド 1'],
  ...
  'pg3-maisonette': {
    slug: 'pg3-maisonette',
    checkoutRoom: 'pg3_maisonette',
    name: 'HOTEL PG-III メゾネット洋室',
    subtitle: 'メゾネット洋室｜静かな港町ステイ',
    address: '広島県尾道市因島土生町1747-5',
    mapLabel: 'HOTEL PGⅢ',
    facts: [
      { label: '個室', value: '個室' },
    ...
    notes: [
      'メゾネットタイプの特別室です。グループ利用にもおすすめですが、住宅地のため夜間は静かにお過ごしください。',
      'パーティ利用は可能ですが、近隣への配慮をお願いいたします。',
    ],
    about: [
      '因島の静かな港町に佇む、メゾネットタイプの特別室です。',
      '上下階に分かれた開放感のある空間で、ご家族やグループ旅行、長期滞在にも快適にお過ごしいただけます。',
      'お部屋には専用バスルーム・無料Wi-Fiを完備。落ち着いたインテリアと静かな環境で、まるで暮らすように滞在できます。',
      '夜には遠くに聞こえる港の音や、窓を開けた時の潮の香りなど、因島らしい穏やかな時間をお楽しみください。',
      '徒歩圏内にはコンビニや波止場もあり、観光・ビジネスどちらにも便利な立地です。',
    ],
    bedTypes: ['ダブル 2', '布団/床用マットレス 3', 'ソファベッド 1'],
    houseRules: [
      { label: 'ペットOK', value: 'いいえ' },
      { label: '喫煙OK', value: 'いいえ' },
      { label: 'イベント&パーティOK', value: 'はい' },
    ...
    priceSummary: {
      ...
      weekend: 34400,
      weekendRule: '金・土',
      extraPerson: '3名以上 1名追加ごとに +¥5,200/泊',
    },
    amenities: [
      '専用バスルーム',
      'Wi-Fi',
    ...
    images: [
      '/hotel3/pg3-maisonette-01.webp',
      '/hotel3/pg3-maisonette-02.webp',
      '/hotel3/pg3-maisonette-03.webp',
      '/hotel3/pg3-maisonette-04.webp',
      '/hotel3/pg3-maisonette-05.webp',
    ],
  },
};
