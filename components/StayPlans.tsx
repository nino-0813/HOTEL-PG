...
const StayPlans: React.FC = () => {
  ...
  const plans: StayPlan[] = [
    ...
    },
    {
      ...
      schedule: [
        { day: 1, time: '15:00', activity: 'チェックイン' },
        { day: 1, time: '16:00', activity: '早朝のビーチヨガで身体を目覚めさせる' },
        { day: 1, time: '18:00', activity: '地元の新鮮な魚介を使ったディナー' },
        { day: 2, time: '8:00', activity: '朝食後、しまなみ海道サイクリングツアーへ出発' },
